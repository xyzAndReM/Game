...
class Plus():
    ...
    def __init__(self,x,y,score,colour):
        self.x = x
        self.y = y
        self.score = score
        self.endurance = 120
...
class Environment:
    ...
    def addParticles(self, n=1, **kargs):
        ...
        if(n == 1):
            return p
    def BubblePoP(self,particle,worth):
        ...
        self.points += (self.rank + 1)*100*worth
        self.scores.append(Plus(particle.x,particle.y,(self.rank + 1)*100,particle.colour))
    ...
    def bounce(self,particle):
        ...
        if particle.y > self.height + particle.size - 150:
            if(particle.colour != blue and particle.colour != purple):
                self.particles.remove(particle)
            elif(particle.colour == purple):
                self.BubblePoP(particle,1)
